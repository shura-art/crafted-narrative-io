    ...
    <main id="main-content" tabIndex={-1} className="flex min-h-screen items-center justify-center p-4 outline-none">
      <div className="glass-panel w-full max-w-md rounded-2xl p-8 text-center animate-fade-in">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center rounded-lg bg-surface-elevated px-5 py-2.5 text-sm font-medium text-foreground link-underline focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none transition-all"
        >
          Return to Home
        </Link>
      </div>
