...
const Index = () => {
  ...
  return (
    <main
      id="main-content"
      tabIndex={-1}
      className="min-h-screen w-full px-4 py-8 outline-none sm:px-8 sm:py-12 md:px-12 lg:px-16 lg:py-16"
    >
            ...
            <section className="flex flex-col gap-10 animate-fade-up" style={{ animationDelay: "0.15s" }}>
              ...
              <Section title="Портфолио">
                <a
                  ...
                  className="group inline-flex items-center gap-2 link-underline rounded-sm text-[15px] text-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-4 focus-visible:ring-offset-background"
                >
                    ...
                    <div className="animate-slide-down mt-4 overflow-hidden rounded-xl border border-hairline bg-surface-elevated/60 px-5 py-4">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <a
                            href={`tel:${PROFILE.contacts.phoneRaw}`}
                            className="mt-1 block rounded-sm font-display text-xl font-semibold tracking-wide text-foreground link-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-4 focus-visible:ring-offset-background"
                          >
                            {PROFILE.donate}
                          </a>
                        </div>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-hairline bg-surface text-muted-foreground transition-all duration-300 hover:border-accent-glow/60 hover:text-accent-glow hover:shadow-[0_0_15px_rgba(var(--accent-glow-rgb),0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                            >
                              {copied ? (
...
const ContactRow = ({
  ...
  <li>
    <a
      ...
      className="group flex items-center gap-3 rounded-lg px-2 py-1.5 -mx-2 transition-all duration-300 hover:bg-surface-elevated/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
