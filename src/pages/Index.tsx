            ...
            <section className="flex flex-col gap-10 animate-fade-up" style={{ animationDelay: "0.15s" }}>
              ...
              <Section title="Портфолио">
                <a
                  ...
                  className="group inline-flex items-center gap-2 link-underline text-[15px] text-foreground/90 focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none rounded-md px-1.5 py-0.5 -mx-1.5 transition-all"
                >
                    ...
                    <div className="animate-slide-down mt-4 overflow-hidden rounded-xl border border-hairline bg-surface-elevated/60 px-5 py-4">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <a
                            href={`tel:${PROFILE.contacts.phoneRaw}`}
                            className="mt-1 block font-display text-xl font-semibold tracking-wide text-foreground link-underline focus-visible:ring-2 focus-visible:ring-accent-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none rounded-md px-1.5 py-0.5 -mx-1.5 transition-all"
                          >
                            {PROFILE.donate}
                          </a>
                        </div>
